...
from Ex11_main_page import MainPage
from Ex11_Rapport import Rapport
...
def main():
    ...
    try:
        ...
        page.charger()
        page.attendre_livres()

        print("\n--- Phase 2: Extraction des Données ---")
        livres = page.get_livres()

        rapport = Rapport(livres)
        #rapport.generer_rapport()
        
        #Export du rapport
        rapport.exporter_rapport("outputs/rapport.txt")

    except Exception as e:
        print(f"Erreur : {e}")

    finally:
        print("\nFermeture du naavigateur...")
        driver.quit()
        print("    Fermé")
